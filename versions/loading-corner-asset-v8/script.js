  ...
  if (!hasGsap) {
    ...
    if (hasOpening) {
      ...
      const finishOpening = () => {
        ...
        gsap.set(".hero-corner-asset", { autoAlpha: 0.88, filter: "blur(0px)", scale: 1, rotation: -2 });
      ...
      gsap.set(".hero-corner-asset", { autoAlpha: 0, filter: "blur(8px)", scale: 0.92, rotation: -2 });
      if (hasOpeningAsset) {
      ...
      if (hasOpeningAsset && document.querySelector(".hero-corner-asset")) {
        tl.to(".opening__asset", {
          ...
          .to(".hero-corner-asset", { autoAlpha: 0.88, filter: "blur(0px)", scale: 1, duration: 0.18, ease: "power2.out" }, 1.62)
          .to(".opening__asset", { autoAlpha: 0, duration: 0.16, ease: "power2.out" }, 1.62);
      }
