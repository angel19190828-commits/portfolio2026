(function () {
  ...
  const collage = [
    { col: 0, row: 0, r: -1.1, startR: -4.0, dy: 176, dz: -280, rx: 16, ry: -9, s: 0.9, o: 0.1, z: 4 },
    { col: 1, row: 0, r: 0.5, startR: 3.0, dy: 136, dz: -220, rx: 13, ry: -3, s: 0.94, o: 0.2, z: 5 },
    { col: 2, row: 0, r: -0.4, startR: -2.8, dy: 158, dz: -250, rx: 15, ry: 4, s: 0.92, o: 0.16, z: 4 },
    { col: 3, row: 0, r: 0.7, startR: 3.6, dy: 122, dz: -205, rx: 12, ry: 9, s: 0.95, o: 0.24, z: 5 },
    { col: 0, row: 1, r: 0, startR: 1.6, dy: 110, dz: -170, rx: 10, ry: -8, s: 0.95, o: 0.28, z: 7 },
    { col: 1, row: 1, r: -0.2, startR: -2.2, dy: 148, dz: -230, rx: 14, ry: -2, s: 0.92, o: 0.17, z: 8 },
    { col: 2, row: 1, r: 0.2, startR: 2.0, dy: 126, dz: -195, rx: 11, ry: 3, s: 0.94, o: 0.22, z: 8 },
    { col: 3, row: 1, r: 0, startR: -1.5, dy: 166, dz: -260, rx: 15, ry: 8, s: 0.91, o: 0.15, z: 7 },
    { col: 0, row: 2, r: -0.6, startR: -3.2, dy: 148, dz: -240, rx: 18, ry: -10, s: 0.92, o: 0.17, z: 4 },
    { col: 1, row: 2, r: 0.8, startR: 3.8, dy: 194, dz: -330, rx: 20, ry: -4, s: 0.88, o: 0.08, z: 5 },
    { col: 2, row: 2, r: -0.4, startR: -3.0, dy: 162, dz: -280, rx: 17, ry: 5, s: 0.91, o: 0.14, z: 5 },
    { col: 3, row: 2, r: 0.6, startR: 2.6, dy: 132, dz: -220, rx: 14, ry: 10, s: 0.94, o: 0.22, z: 4 }
  ];
  ...
  function placeInitial(layout) {
    items.forEach((item, index) => {
      ...
      item.dataset.startZ = String(seed.dz);
      item.dataset.startRX = String(seed.rx);
      item.dataset.startRY = String(seed.ry);
