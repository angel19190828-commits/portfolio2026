  ...
  function placeInitial(layout) {
    ...
    items.forEach((item, index) => {
      ...
      gsap.set(item, {
        ...
        scale: seed.s,
        autoAlpha: seed.o,
        filter: `blur(1.8px) saturate(${seed.depth > 0 ? ".9" : ".84"}) contrast(.97)`,
        zIndex: seed.z
      });
    });
    ...
    gsap.set(titleWrap, { autoAlpha: 0, scale: 1, x: 0, y: 0 });
  ...
  function buildSection2() {
    ...
    section2Timeline = gsap.timeline({
      scrollTrigger: {
        ...
        trigger: section,
        start: () => {
          const section1 = ScrollTrigger.getById("section1-work-carousel");
          return section1 ? section1.end : "top top";
        },
        ...
        onEnter: () => {
          ...
          gsap.set(titleWrap, { autoAlpha: 1 });
    ...
    section2Timeline.set(grid, { autoAlpha: 1 }, 0.11);
    ...
    items.forEach((item, index) => {
      ...
      const start = 0.16 + row * 0.018 + Math.abs(col - 1.5) * 0.01;
      section2Timeline
        .to(item, {
          autoAlpha: 0.62,
          filter: "blur(1.2px) saturate(.9) contrast(.98)",
          duration: 0.14,
          ease: "power2.out"
        }, start)
        .to(item, {
