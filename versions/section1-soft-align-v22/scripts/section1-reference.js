(function () {
  ...
  function buildWorkTimeline() {
    ...
    renderTick = () => {
      ...
      if (idleFor > 110 && wheelMotion.targetOutro < 0.08) {
        const settleSlot = gsap.utils.clamp(0, maxPosition, Math.round(wheelMotion.currentPosition + wheelMotion.velocity * 2.2));
        wheelMotion.targetSlot = settleSlot;
        wheelMotion.targetPosition = settleSlot;
      }
      ...
      const idleSettle = idleFor > 110 ? 0.016 : 0;
