    ...
    if (hasOpening) {
      ...
      if (hasOpeningAsset) {
        tl.fromTo(".opening__asset",
          ...
          { autoAlpha: 1, y: 0, scale: 1, rotation: 0.4, filter: "blur(0px) saturate(1)", duration: 0.62, ease: "power3.out" },
          0
        )
          .to(".opening__asset", { scale: 1.026, rotation: -0.25, filter: "blur(.5px) brightness(1.18)", duration: 0.16, ease: "power2.out" }, 0.62)
          .to(".opening__asset", { scale: 1, rotation: 0, filter: "blur(0px) brightness(1)", duration: 0.24, ease: "power2.out" }, 0.78);
      }
      tl.fromTo(".opening__hero-line",
          { autoAlpha: 0, y: 18, scale: 0.98, filter: "blur(12px)" },
          { autoAlpha: 1, y: 0, scale: 1, filter: "blur(0px)", duration: 0.46, ease: "power3.out" },
          hasOpeningAsset ? 0.72 : 0
        )
        .to(".opening__asset", { autoAlpha: 0.18, scale: 0.985, filter: "blur(10px)", duration: 0.48, ease: "power3.inOut" }, 1.22)
        .to(".opening__hero-line", { autoAlpha: 0, y: -10, filter: "blur(8px)", duration: 0.34, ease: "power3.inOut" }, 1.36)
        .to(".opening", { autoAlpha: 0, filter: "blur(8px)", duration: 0.46, ease: "power3.inOut" }, 1.52)
